...
TH1F *htof = new TH1F("htof","Time of Flight",5000,0.,5000.);
...
TH2F *hpad1vstof = new TH2F("hpad1vstof","Scint 1 vs time of flight",4000,0.,4000.,2000,0.,4000.);
...
TH2F *hpad2vstof = new TH2F("hpad2vstof","Scint 2 vs time of flight",1000,4000.,5000.,2000,0.,4000.);
...
TH2F *htofvsX1 = new TH2F("htofvsX1","time of flight vs X position",1600,0.,800.,400,2500.,5200.);
...
TH2F *hY1vsEx = new TH2F("hY1vsEx","Y1 vs Ex",2400,5.,25.,250,-70.,70.);
...
TH2F *hThSCATvsX1 = new TH2F("hThSCATvsX1","SCATTERING Theta vs X position",3200,0.,800.,600,-3.,3.);
...
// wire nr vs drifttime: trying to get to the bottom of the noisy vdcs: old vs new. Also the high threshold is a problem...
TH2F *hposvstime = new TH2F("hposvstime","pos vs time", 2000,-15000.,15000.,800,0,800);
TH2F *hwirevstime = new TH2F("hwirevstime","wire vs time", 2000,-15000.,15000.,200,0,200);
TH2F *hwirevsdist = new TH2F("hwirevsdist","wire vs dist", 200,0,200, 800,0.,8.);
...
TH2F *hY1vswire = new TH2F("hY1vswire","wire vs Y", 200,0,200,280,-70,70);
TH2F *hwirevswire = new TH2F("hwirevswire","U wire vs X wire", 200,0,200,200,0,200);
TH2F *hU1vsX1 = new TH2F("hU1vsX1","U1 vs X1",2400,0.,800.,2400,0.,800.);

TH2F *hwiresvschi = new TH2F("hwiresvschi","nr of wires vs chisq", 20,0,20, 2000,0,1);    
TH2F *hwireNRvschi = new TH2F("hwireNRvschi","wire nr vs chisq", 200,0,200, 2000,0,1);    
TH2F *hX1vschi = new TH2F("hX1vschi","X1pos vs chisq", 800,0,800, 200,0,1);    
...
//TH2F *hThSCATvsXcorr = new TH2F("hThSCATvsXcorr","corrected SCAT Theta vs X position",1600,0.,800.,500,-5.,5.);

//TH2F *hYvsXdiff = new TH2F("hYvsXdiff","DIFF",1000,-2000.,2000.,600,-100.,100.);

//TH2F *hY1vsPhiFP = new TH2F("hY1vsPhiFP","Y vs Phi Focal Plane",100,-20.,20.,240,-60.,60.);
...
//DATAChain->Draw("(X1pos+0.9*ThSCAT-0.4*ThSCAT^2+0.1*ThSCAT^4)>>hX1posb",CUTbasic && CUTpad2 && CUTlimits && CUTY2,"");
//DATAChain->Draw("(X1pos+0.9*ThSCAT-0.4*ThSCAT^2+0.1*ThSCAT^4)>>hX1posa",CUTbasic && CUTpad2 && CUTlimits && CUTY,"same");
